...
# Define the schemas for the data models
...
# Define the structured plan for the project    
...
# Define the implementation steps for the plan    
...
# define the task plan containing multiple implementation steps in a list
class TaskPlan(BaseModel):
    implementation_steps: list[ImplementationTask] = Field(description="A list of steps to be taken to implement the task")
    model_config = ConfigDict(extra="allow")
    
# Define the state for coder agent to keep track of current step and file content
